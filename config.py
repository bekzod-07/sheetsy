...
SCOPES = [
    ...
    "https://www.googleapis.com/auth/spreadsheets",        # write (append) uchun
    "https://www.googleapis.com/auth/spreadsheets.readonly" # <-- qo‘shimcha (Google qaytarsa ham mos tushadi)
]
